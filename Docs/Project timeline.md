...
- [True] Restructure GitHub repo  
- [True] Create solution with 4 projects (API / Application / Domain / Infra)  
...
**~36 hrs · Goal:** Buyer can order, Stripe works  
...
**~72 hrs · Goal:** Working UI connected to API  
